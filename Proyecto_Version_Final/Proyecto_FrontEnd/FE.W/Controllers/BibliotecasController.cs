...
namespace FE.W.Controllers
{
    public class BibliotecasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdVideo,TituloVideo,UrlVideo,DescripcionVideo")] Biblioteca biblioteca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVideo,TituloVideo,UrlVideo,DescripcionVideo")] Biblioteca biblioteca)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!BibliotecaExists(biblioteca.IdVideo))
                    {
                        return NotFound();
                    }
                    else
