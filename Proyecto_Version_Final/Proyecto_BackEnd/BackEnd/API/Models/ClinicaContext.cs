...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=tcp:diagonalley.database.windows.net,1433;Initial Catalog=Clinica;Persist Security Info=False;User ID=potter;Password=Qn5Yhbcb;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Trusted_Connection=False;Connection Timeout=30;");
            }
        }
