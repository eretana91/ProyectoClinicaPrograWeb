...
namespace API.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(ClinicaMedicaV1Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Usuarios>> PostUsuarios(Usuarios usuarios)
        {
            ...
            return CreatedAtAction("GetUsuarios", new { id = usuarios.CodigoUsuario }, usuarios);
        }
