...
namespace API.Controllers
{
    ...
    public class TipoUsuarioController : ControllerBase
    {
        ...
        public TipoUsuarioController(ClinicaMedicaV1Context context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<TipoUsuario>> PostTipoUsuario(TipoUsuario tipoUsuario)
        {
            ...
            return CreatedAtAction("GetTipoUsuario", new { id = tipoUsuario.CodigoTipoUsuario }, tipoUsuario);
        }
        ...
        {
            return _context.TipoUsuario.Any(e => e.CodigoTipoUsuario == id);
        }
    }
}
